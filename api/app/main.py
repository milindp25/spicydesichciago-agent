...
from app.infrastructure.firestore_daily_stats_store import (  # noqa: E402
    FirestoreDailyStatsStore,
)
...
def _build() -> FastAPI:
    ...
    state = AppState(
        ...
        callback_token_secret=settings.callback_link_signing_secret,
        callback_token_ttl=settings.callback_link_ttl_seconds,
        callback_public_url=settings.callback_public_url,
